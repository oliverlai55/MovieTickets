  ...
  componentWillMount() {
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderMove: (evt, gestureState) => {
        // Pull delta and velocity values for y acis from gestureState
        const { dy, vy } = gestureState;
        // Subtract delta y from previous heigh to get new height
          ...
          <View style={styles.content}>
            ...
            >
              ...
              <View style={[styles.movieInfo, this.getStyles().movieInfo]}>
                <Text style={[styles.title, this.getStyles]}>{title}</Text>
